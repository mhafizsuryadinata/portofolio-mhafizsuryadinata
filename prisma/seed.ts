...
async function main() {
  ...
  const profile = await prisma.profile.upsert({
    ...
    create: {
      ...
      status: "Mahasiswa",
      bio: "Saya adalah seorang mahasiswa teknologi informasi yang berdedikasi tinggi dan memiliki minat besar dalam pengembangan web dan mobile. Saya senang memecahkan masalah kompleks, mempelajari teknologi baru, dan membangun solusi digital yang efisien, estetis, dan berdampak positif bagi masyarakat.",
      vision: "Menjadi Software Engineer profesional yang mampu berkontribusi nyata dalam transformasi digital dengan menciptakan solusi pemrograman yang inovatif, aman, dan berdaya guna tinggi.",
      careerGoals: "Terus mengembangkan keahlian teknis di bidang Frontend & Backend, memperdalam arsitektur sistem cloud, berpartisipasi aktif dalam proyek open source, serta mendapatkan kesempatan magang atau kerja di perusahaan teknologi terkemuka untuk membangun personal branding yang kokoh.",
  ...
  if (educationsCount === 0) {
    await prisma.education.createMany({
      data: [
        ...
        {
          schoolName: "SMA / Pondok Pesantren Terpadu",
          degree: "Pendidikan Menengah Atas",
          period: "2019 - 2022",
          description: "Mendalami studi keagamaan sekaligus sains, aktif memimpin kegiatan organisasi santri, serta mulai tertarik pada dunia algoritma dan pemrograman.",
          order: 3,
        },
        {
          schoolName: "Universitas Terkemuka",
          degree: "S1 Teknik Informatika / Sistem Informasi",
          period: "2022 - Sekarang",
          description: "Fokus pada pengembangan perangkat lunak, pemrograman web, mobile development, arsitektur basis data, serta aktif dalam Unit Kegiatan Mahasiswa (UKM) pemrograman.",
          order: 4,
        },
      ],
    });
